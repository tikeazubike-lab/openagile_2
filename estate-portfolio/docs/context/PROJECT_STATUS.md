---
type: CONTEXT
id: EPM-PROJECT-STATUS
title: EPM Project Status Board
status: ARCHIVAL_REFERENCE
version: 1.0
updated: 2026-05-23
source_last_updated: 2026-05-18
---
...
|---|------|-----|--------|-------------|
| 1 | Holdings | Delete mutation not persisting | ✅ DONE | HO-014 |
| 2 | Holdings | Edit mode off doesn't clear inline fields | ✅ DONE | HO-014 |
| 3 | Price Entry | PDF upload may not write to price_history | ✅ DONE | HO-014 |
| 4 | Auth | 30-day cookie Max-Age — verify in Set-Cookie header | ⚠️ Verify needed | HO-011 |
| 5 | Holdings | Holdings PATCH field name, type, validation | ✅ DONE | HO-016 |
| 6 | Dashboard | Sector allocation name field, Recharts data parsing | ✅ DONE | HO-016 |
