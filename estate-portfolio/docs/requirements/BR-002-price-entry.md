...
## Section 9: Phase 3C — Batch Historical Upload
...
Processing:
  ...
  4. Write price_history records for each file
...
**Frontend Updates for Phase 3C**:
- `/settings/price-entry` right panel will add a second tab: `[Single PDF] | [Batch Upload (up to 30 PDFs)]`
- Batch tab will include a multi-file drop zone, list of selected files with detected dates, an `[Upload All]` button, and progress/result summary per file.
