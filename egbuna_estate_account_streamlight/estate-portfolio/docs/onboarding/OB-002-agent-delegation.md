...
# [OB] OB-002 — Agent Delegation

> **Note**: This file covers the EPM project only
> (`egbuna_estate_account_streamlight/estate-portfolio/`).
> The workspace-level `AGENTS.md` at the monorepo root covers all five
> projects and platform-level rules (Frappe, ERPNext, infrastructure).
> For EPM CI/CD and deployment, follow this file — it is the authoritative
