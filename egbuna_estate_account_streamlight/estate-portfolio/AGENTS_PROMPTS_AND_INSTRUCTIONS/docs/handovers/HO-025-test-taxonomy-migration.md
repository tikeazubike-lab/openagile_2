...
type: HO
id: HO-025
title: Claude → Deepseek:flash: Test Taxonomy Migration (Urgent)
date: 2026-06-25
from: Claude (The Brain)
to: Deepseek:flash (Codex executor)
...
Can be done in parallel with HO-024 frontend work (nemotron-3-ultra-550b-55b:free).
